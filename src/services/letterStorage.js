...
import { BAKED_LETTERS, BAKED_LETTER_ORDER } from '../data/baked_letters.js?v=1786728784';
import { BAKED_MEMORIES, BAKED_MEMORY_ORDER } from '../data/baked_memories.js?v=1786728784';
...
class LetterStorageService {
  ...
  getLetterOrder() {
    try {
      ...
      return data ? JSON.parse(data) : BAKED_LETTER_ORDER;
    } catch (e) {
      return BAKED_LETTER_ORDER;
    }
  }
  ...
  getMemoryOrder() {
    try {
      ...
      return data ? JSON.parse(data) : BAKED_MEMORY_ORDER;
    } catch (e) {
      return BAKED_MEMORY_ORDER;
    }
  }
